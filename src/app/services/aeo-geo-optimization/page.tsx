...
export const metadata: Metadata = {
  title: "AEO & GEO Services | AI Search Agency, Lahore",
  description:
    "RankNex AI helps businesses get recommended by ChatGPT, Perplexity, and Google AI Overviews via Answer Engine (AEO) and Generative Engine Optimization (GEO).",
  keywords: [
  ...
  openGraph: {
    title: "AEO & GEO Services | AI Search Agency, Lahore | RankNex AI",
    description:
